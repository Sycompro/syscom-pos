...
import { X, Dumbbell, Store, Check, Info, UploadCloud, Loader2, Keyboard, Palette, Briefcase } from 'lucide-react';
        ...
        <AnimatePresence>
            <div style={overlayStyle}>
                ...
                >
                    ...
                    {/* Content */}
                    <div style={{ ...contentStyle, maxHeight: '70vh', overflowY: 'auto', display: 'flex', flexDirection: 'column' }}>
                        {loading ? (
                            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '60px 0' }}>
                                <Loader2 className="animate-spin" size={32} color="#3b82f6" />
                                <p style={{ marginTop: '12px', fontSize: '13px', fontWeight: 650, color: '#64748b' }}>Cargando configuraciones...</p>
                            </div>
                        ) : (
                            <>
                                    ...
                                    <AnimatePresence mode="wait">
                                        {currentTab === 'business' && (
                                            ...
                                            >
                                                ...
                                                <p style={infoTextStyle}>
                                                    <Info size={14} /> Determina las reglas de negocio y las alertas específicas que se envían.
                                                </p>
                                                ...
                                                <div style={gridStyle}>
                                                    ...
                                                    >
                                                        ...
                                                        <div style={{ flex: 1 }}>
                                                            ...
                                                            <p style={optionDescStyle}>Habilita el control de vigencia, días de membresía y alertas de vencimiento en mensajes.</p>
                                                        </div>
                                                    ...
                                                    >
                                                        ...
                                                        <div style={{ flex: 1 }}>
                                                            ...
                                                            <p style={optionDescStyle}>Mensajes estándar de agradecimiento de compra sin vigencia de membresías.</p>
                                                        </div>
                                        ...
                                        {currentTab === 'interface' && (
                                            ...
                                            >
                                                ...
                                                <p style={infoTextStyle}>
                                                    <Info size={14} /> Activa o desactiva los teclados de cristal en pantalla para la aplicación.
                                                </p>
                                        ...
                                        {currentTab === 'brand' && (
                                            ...
                                            >
                                                ...
                                                <p style={infoTextStyle}>
                                                    <Info size={14} /> Personaliza el nombre comercial y logo de comprobantes.
                                                </p>
                                                ...
                                                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(110px, 1fr))', gap: '12px', marginTop: '6px' }}>
