...
export async function GET(request) {
    ...
    if (!query || query.length < 8) return NextResponse.json({ data: null });
    ...
    try {
        ...
        const erpRes = await pool.request()
                ...
                .query("SELECT TOP 1 codcli, nomcli, ruccli, nrodni, dircli, celcli, telcli, fecnac, fecfinpres FROM mst01cli WHERE LTRIM(RTRIM(ruccli)) = @q OR LTRIM(RTRIM(nrodni)) = @q");
